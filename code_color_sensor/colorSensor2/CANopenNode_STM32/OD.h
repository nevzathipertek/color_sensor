...
********************************************************************************
    ...
    File info:
        ...
        Project File: colorSensorCanopen.xpd
        File Version: 01.01

        Created:      5/19/2023 10:27:12 AM
        Created By:   HiperTeknoloji
        Modified:     7/9/2024 4:40:44 PM
        Modified By:  HiperTeknoloji

    Device Info:
        Vendor Name:  HiperTeknoloji
        Vendor ID:    001.01
        Product Name: colorSensorCanopen
        Product ID:   001

        Description:  color sensor system communacition
*******************************************************************************/
...
#define OD_ENTRY_H6400 &OD->list[21]
#define OD_ENTRY_H6401 &OD->list[22]
#define OD_ENTRY_H6402 &OD->list[23]
#define OD_ENTRY_H6403 &OD->list[24]
#define OD_ENTRY_H6404 &OD->list[25]
#define OD_ENTRY_H6405 &OD->list[26]
...
#define OD_ENTRY_H6400_red_RGB888 &OD->list[21]
#define OD_ENTRY_H6401_green_RGB888 &OD->list[22]
#define OD_ENTRY_H6402_blue_RGB888 &OD->list[23]
#define OD_ENTRY_H6403_cct_ColorTemperature &OD->list[24]
#define OD_ENTRY_H6404_illimunate &OD->list[25]
#define OD_ENTRY_H6405_statusRegister &OD->list[26]
